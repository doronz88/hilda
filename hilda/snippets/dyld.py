...
import lldb
from construct import Struct, Pointer, this, CString, Int64ul, If, Int32ul, Tell, Int32ub, Array, Hex
...
from hilda.snippets.macho import mach_header


dyld_image_info = Struct(
    '_imageLoadAddress' / SymbolFormatField(lldb.hilda_client),
    'imageLoadAddress' / Pointer(this._imageLoadAddress, mach_header),
...
all_image_infos_t = Struct(
    ...
    'infoArray' / Pointer(this._infoArray, Array(this.infoArrayCount, dyld_image_info)),
    ...
    'dyldImageLoadAddress' / Pointer(this._dyldImageLoadAddress, mach_header),
...
def all_image_infos():
    with lldb.hilda_client.stopped(1):
        ...
        return all_image_infos_t.parse_stream(all_image_infos_symbol)
