...
class Configs:
    ...
    Attributes:
    ----------
    evaluation_unwind_on_error : bool
        Whether to unwind on error during evaluation.
    evaluation_ignore_breakpoints : bool
        Whether to ignore breakpoints during evaluation.
    nsobject_exclusion : bool
        Whether to exclude NSObject during evaluation - reduce ipython autocomplete results.
    objc_verbose_monitor : bool
        When set to True ,using monitor()  will automatically print objc methods arguments.
    """
    evaluation_unwind_on_error: bool = False
    evaluation_ignore_breakpoints: bool = False
    nsobject_exclusion: bool = False
    objc_verbose_monitor: bool = False
...
class HildaClient:
    ...
    def bt(self, should_print=False, depth: Optional[int] = None) -> List:
    ...
    @stop_is_needed
    def disass(self, address, buf, flavor='intel', should_print=False) -> lldb.SBInstructionList:
        """
    ...
    def interact(self, additional_namespace: typing.Mapping = None, startup_files: Optional[List[str]] = None) -> None:
