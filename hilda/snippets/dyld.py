...
class DyldStructFactory(object):
    ...
    def all_image_infos():
        return Struct(
            ...
            '_dyld_image_info' / SymbolFormatField(lldb.hilda_client),
            'dyld_image_info' / Pointer(this._dyld_image_info, Array(this.infoArrayCount,
                                                                     DyldStructFactory.dyld_image_info())),
